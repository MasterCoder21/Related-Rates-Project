...
public class AnimationPanel extends JPanel {
	...
	public void paint(Graphics g) {
		...
		if (height < HEIGHT_MAX)
			g.drawLine(offset, (int) (this.getHeight() - 50 - height), (int) (offset + otherLeg),
					this.getHeight() - 50);
		else
			g.drawLine(offset, (int) (this.getHeight() - 50 - height), (int) (offset),
					(int) (this.getHeight() - 50 - (height - HEIGHT_MAX)));
